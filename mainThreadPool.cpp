...
void copyMatrix(){
    ...
    for (i=0; i<N; i++){
        threads.emplace_back(taskPool.enqueue([i]() {
            int j,l;
            for (j=0; j<M; j++){
                for (l=0; l<Q; l++){
...
int main() {
    ...
    while(true){
        ...
        for(j=1; j<M-1; j++){
            threads.emplace_back(taskPool.enqueue([j]() {
                int l;
                for (l = 1; l < Q - 1; l++) {
                    int i;
